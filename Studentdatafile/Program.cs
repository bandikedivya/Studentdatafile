...
namespace Studentdatafile
{
    internal class Program
    {
        ...
        private static void OpenAndReadTXTFile()
        {
            ...
            bool ans = File.Exists(@"C:\Users\divya\Documents\Assisted Project\Retreive Data from Text-24Oct\Studentdatafile.txt");
            if (ans == true)
            {
                ...
                try
                {
                    ...
                    FileStream fs = new FileStream(@"C:\Users\divya\Documents\Assisted Project\Retreive Data from Text-24Oct\Studentdatafile.txt", FileMode.Open, FileAccess.Read);
        ...
        private static void CreateAndWriteTXTFile()
        {
            ...
            FileStream fs = new FileStream(@"C:\Users\divya\Documents\Assisted Project\Retreive Data from Text-24Oct\Studentdatafile.txt", FileMode.Create, FileAccess.Write);
            ...
            try
            {
                ...
                writing.WriteLine("Student enrolled courses : C# , python ");
